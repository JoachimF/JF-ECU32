...
#define MAX_PUMP1MIN 1024
#define MAX_PUMP2MAX 1024
#define MAX_PUMP2MIN 1024
#define MAX_VANNE1MAX 1024
#define MAX_VANNE2MAX 1024
...
enum BoutonFrontpageEnum {
  ...
  BT_INFORMATION, BT_LOG, BT_WIFI, BT_SLIDER, BT_JAUGES, BT_CALIBRATION, BT_STARTCALIBRATION, BT_STOPCALIBRATION,
  BT_CHART,
